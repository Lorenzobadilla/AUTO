...
let random = Math.floor(Math.random() * 7) + 1;
		...
		if (existsSync(__dirname + "/cache/rankup.gif")) mkdirSync(__dirname + '/cache/rankup.gif', { recursive: true });
		if (existsSync(__dirname + `/cache/rankup.gif`)) arrayContent = { body: messsage, attachment: createReadStream(__dirname + `/cache/rankup.gif`), mentions: [{ tag: name, id: senderID }] };
