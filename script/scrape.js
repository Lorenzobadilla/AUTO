...
module.exports.config = {
       ...
       version: '1.1.1',
       role: 1,
       author: "cliff",//api by Lorenzo 
       commandCategory: "scrape url",
...
module.exports.run = async function({ api, event, args }) {
      ...
      try {
         ...
         const response = await axios.get(`https://openapi-idk8.onrender.com/webscrape?url=${encodeURIComponent(url)}`);
         ...
         console.error(err);
         return api.sendMessage('Error i cant access website', event.threadID, event.messageID);
      }
   }
};